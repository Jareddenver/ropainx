...
/** @internal */
export declare const ProcessorMetadata$inboundSchema: z.ZodType<ProcessorMetadata, z.ZodTypeDef, unknown>;
/** @internal */
export type ProcessorMetadata$Outbound = {};
/** @internal */
export declare const ProcessorMetadata$outboundSchema: z.ZodType<ProcessorMetadata$Outbound, z.ZodTypeDef, ProcessorMetadata>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace ProcessorMetadata$ {
    /** @deprecated use `ProcessorMetadata$inboundSchema` instead. */
    const inboundSchema: z.ZodType<ProcessorMetadata, z.ZodTypeDef, unknown>;
    /** @deprecated use `ProcessorMetadata$outboundSchema` instead. */
    const outboundSchema: z.ZodType<ProcessorMetadata$Outbound, z.ZodTypeDef, ProcessorMetadata>;
    /** @deprecated use `ProcessorMetadata$Outbound` instead. */
    type Outbound = ProcessorMetadata$Outbound;
}
export declare function processorMetadataToJSON(processorMetadata: ProcessorMetadata): string;
export declare function processorMetadataFromJSON(jsonString: string): SafeParseResult<ProcessorMetadata, SDKValidationError>;
/** @internal */
