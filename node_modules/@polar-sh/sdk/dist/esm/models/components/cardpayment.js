...
/** @internal */
export const ProcessorMetadata$inboundSchema = z.object({});
/** @internal */
export const ProcessorMetadata$outboundSchema = z.object({});
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var ProcessorMetadata$;
(function (ProcessorMetadata$) {
    /** @deprecated use `ProcessorMetadata$inboundSchema` instead. */
    ProcessorMetadata$.inboundSchema = ProcessorMetadata$inboundSchema;
    /** @deprecated use `ProcessorMetadata$outboundSchema` instead. */
    ProcessorMetadata$.outboundSchema = ProcessorMetadata$outboundSchema;
})(ProcessorMetadata$ || (ProcessorMetadata$ = {}));
export function processorMetadataToJSON(processorMetadata) {
    return JSON.stringify(ProcessorMetadata$outboundSchema.parse(processorMetadata));
}
export function processorMetadataFromJSON(jsonString) {
    return safeParse(jsonString, (x) => ProcessorMetadata$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ProcessorMetadata' from JSON`);
}
/** @internal */
